...
# That added string will be captured using a variable called name as shown below. Note that the variable does not
...
# run the app notice here that we can specify host. 0.0.0.0 means that the app
# will be accessible from all the IP
